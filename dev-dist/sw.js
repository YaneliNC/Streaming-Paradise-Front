...
define(['./workbox-25659a9f'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/\/offline/, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/\.(woff|woff2|ttf|otf|eot|svg)$/, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/fontawesome-free\/css\/.*\.css/, new workbox.StaleWhileRevalidate({
